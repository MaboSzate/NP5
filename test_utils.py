...
class Sajat(unittest.TestCase):
    ...
    def test_calc_simple_var(self):
        ...
        window_in_days = 250
        df_var, df_var_amount =\
        u.calc_simple_var(pf_value, d_weights, l_conf_levels, last_day_of_interval, window_in_days)
        self.assertAlmostEqual(df_var.values[0][0], -0.00459, 4)
        self.assertAlmostEqual(df_var.values[0][1], -0.00663, 4)
        pass
    ...
    def test_calc_covar_var(self):
        ...
        window_in_days = 250
        df_var, df_var_amount =\
        u.calc_covar_var(pf_value, d_weights, l_conf_levels, last_day_of_interval, window_in_days)
        self.assertAlmostEqual(df_var.values[0][0], -0.00459, 4)
        self.assertAlmostEqual(df_var.values[0][1], -0.00663, 4)
